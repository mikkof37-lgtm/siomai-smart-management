...
export default function Sidebar({ currentUser }) {
  ...
  return (
    <aside
      className="shrink-0 border-b md:sticky md:top-0 md:flex md:h-screen md:flex-col md:border-b-0 md:border-r"
      style={{
    ...
    >
      <div className="flex items-center justify-between gap-3 px-4 py-4 md:hidden">
        ...
        <button
          ...
          className="hidden h-10 w-10 shrink-0 items-center justify-center rounded-2xl border border-[#3a261b] bg-[#261a14] text-[#d1c3b6] transition hover:border-[#ff7a1a] hover:text-[#ff9a4a]"
          aria-label={isCollapsed ? "Expand sidebar" : "Collapse sidebar"}
          aria-pressed={isCollapsed}
        >
          <svg viewBox="0 0 24 24" className={`h-4 w-4 transition-transform duration-200 ${isCollapsed ? "rotate-180" : ""}`} fill="none">
            <path
              d="M9 6l6 6-6 6"
              stroke="currentColor"
              strokeWidth="1.8"
